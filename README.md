...
* [X] Made floating action bar to hide while scrolling.
* [X] Moved cursor and pre-filled text with username when replying to tweet. 
## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/R3CMZhM.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Notes

Describe any challenges encountered while building the app.
* Ran out of time for hiding the toolbar on scroll.
* Still some problems with the floating action button.
